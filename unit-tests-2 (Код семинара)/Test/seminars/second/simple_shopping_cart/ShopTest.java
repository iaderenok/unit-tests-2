...
*/
    ...
    void priceCartProductsSameTypeIsCorrectCalculated() {
        ...
        // Assert
        assertEquals(250*3 + 200*3, cart.getTotalPrice(), 0.001);
    ...
    void whenChangingCartCostRecalculationIsCalled() {
        ...
        // Assert
        assertEquals(170 + 250 + 200 + 150 - 250, cart.getTotalPrice(), 0.001);
    }
    ...
    void quantityProductsStoreChanging() {
        ...
        assertEquals(4, quantityBefore - quantityAfter);
    ...
    void deletedProductIsReturnedToShop() {
        ...
        assertEquals(0, quantityBefore - quantityAfter);
    ...
    @Test
    void testSUM() {
//        for (int i = 0; i < shop.getProductsShop().size(); i++) {
//            System.out.println(shop.getProductsShop().get(i).getQuantity());
//            for (int j = 0; j < shop.getProductsShop().get(i).getQuantity(); j++) {
//
//            }
//        }
    }
